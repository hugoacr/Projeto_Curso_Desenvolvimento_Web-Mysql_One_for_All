...
CREATE TABLE User_Song(
    ...
    reproduction_history INT NOT NULL,
    play_date DATETIME NOT NULL,
    CONSTRAINT PRIMARY KEY(user_id, reproduction_history),
    FOREIGN KEY (user_id) REFERENCES User (user_id),
    FOREIGN KEY (reproduction_history) REFERENCES Song (song_id)
) engine = InnoDB;

CREATE TABLE User_Artist(
    user_id INT NOT NULL,
    following_artists INT NOT NULL,
    CONSTRAINT PRIMARY KEY(user_id, following_artists),
    FOREIGN KEY (user_id) REFERENCES User (user_id),
    FOREIGN KEY (following_artists) REFERENCES Artist (artist_id)
) engine = InnoDB;
...
INSERT INTO User (user_id, user_name, age, plan_id, signature_date)
VALUES
...
INSERT INTO Album (album_id, album_name, release_year, artist_id)
VALUES
	('1', 'Envious', '1990', '6'),
	('2', 'Exuberant', '1993', '6'),
...
INSERT INTO Song (song_id, song_name, seconds_duration, album_id)
VALUES
	('1', 'Soul For Us', '200', '1'),
...
INSERT INTO User_Song (user_id, reproduction_history, play_date)
VALUES
...
INSERT INTO User_Artist (user_id, following_artists)
VALUES
	('1', '6'),
	('1', '2'),
	('1', '3'),
